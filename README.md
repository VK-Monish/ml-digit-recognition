...
Backend converts the image to 28×28 grayscale

Image passed to trained CNN model

Model predicts the digit (0–9)

Website displays the output

▶️ Run the App Locally
1. Clone the repository
git clone :https://github.com/VK-Monish/ml-digit-recognition
